    ...
    fun! s:Doxygen_Hilights()
      ...
      if (exists('g:doxygen_enhanced_color') && g:doxygen_enhanced_color) || (exists('g:doxygen_enhanced_colour') && g:doxygen_enhanced_colour)
        if &background=='light'
          ...
          SynColor doxygenBrief ctermfg=Cyan guifg=Blue 
          SynColor doxygenBody ctermfg=Cyan guifg=Blue
          SynColor doxygenSpecialTypeOnelineDesc ctermfg=DarkRed guifg=firebrick3 
          SynColor doxygenBOther ctermfg=DarkMagenta guifg=#aa50aa 
          ...
          SynColor doxygenSpecialOnelineDesc ctermfg=DarkCyan guifg=DodgerBlue3 
